object FormImport: TFormImport
  ...
  object Panel1: TPanel
    ...
    object bCancel: TButton
      ...
      Height = 25
      Hint = 
        'Abort this operation and go back to the main screen without maki' +
        'ng any changes'
    ...
    object GroupBox1: TGroupBox
      ...
      object lvSDX: TListView
        ...
        TabOrder = 0
        ViewStyle = vsReport
        OnColumnClick = lvSDXColumnClick
        OnCompare = lvSDXCompare
        OnCustomDrawItem = lvSDXCustomDrawItem
        OnDblClick = lvSDXDblClick
        OnKeyDown = lvSDXKeyDown
      end
    end
    ...
    object bCheckAll: TButton
      ...
      Width = 101
      Height = 25
      Hint = 'Check all listed services for import'
      Anchors = [akRight, akBottom]
      Caption = 'Check All'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
    ...
    object bUncheckAll: TButton
      ...
      Width = 101
      Height = 25
      Hint = 'Uncheck all listed services for import'
      Anchors = [akRight, akBottom]
      Caption = 'Uncheck All'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
